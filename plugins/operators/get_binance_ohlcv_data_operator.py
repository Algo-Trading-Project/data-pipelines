...
class GetBinanceOHLCVDataOperator(BaseOperator):
    ...
    def _upload_new_ohlcv_data(self, ohlcv_data, year, month, day):
        """
        ...
        path = f'/Users/louisspencer/LocalData/data/ohlcv_data/daily/{symbol_id}_{year}_{month}_{day}.parquet'
    ...
    async def _get_ohlcv_data(self, session, sem, time_start, coinapi_token, binance_metadata):
        ...
        print(df.head())
        print()
        self._upload_new_ohlcv_data(df, year = year, month = month, day = day)
