...
def agg_trade_data_1d(**context):
    ...
    RAW_SPOT_TRADES = f's3://base-44-data/data/trade_data/raw/symbol_id=*/date={prev_date}/*.parquet'
    AGG_SPOT_TRADES = f's3://base-44-data/data/trade_data/agg/'
    ...
    WITH spot_trade_data_agg_1d AS (
        ...
        FROM read_parquet('{RAW_SPOT_TRADES}', hive_partitioning=true)
