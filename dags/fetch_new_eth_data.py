...
with DAG('fetch_new_eth_data',
    ...
    s3_block_data_to_redshift = S3ToRedshiftOperator(
        ...
        s3_key = 'eth_data/block_and_transaction_data/blocks.json',
    ...
    s3_transaction_data_to_redshift = S3ToRedshiftOperator(
        ...
        s3_bucket = 'project-poseidon-data',
        s3_key = 'eth_data/block_and_transaction_data/transactions.json',
        redshift_conn_id = 'redshift_conn',
        aws_conn_id = 's3_conn',
    ...
    s3_transfer_data_to_redshift = S3ToRedshiftOperator(
        ...
        table = 'stg_transfer',
        s3_bucket = 'project-poseidon-data',
        s3_key = 'eth_data/block_and_transaction_data/transfers.json',
        redshift_conn_id = 'redshift_conn',
        aws_conn_id = 's3_conn',
